package pt.ipt.dama.photocamera2
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(checkSelfPermission(Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED || checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED){
            ...
            frame.setOnLongClickListener {
                //the user perss for long time the imageView
                openCamera()
                true
    ...
    /**
     * open the gallery to show photos
     */
    ...
    private fun uriToBitmap(selectedFileUri: Uri):Bitmap{
        try {
            val parcelFileDiscriptor = contentResolver.openFileDescriptor(selectedFileUri, "r")

            val fileDescriptor:FileDescriptor = parcelFileDiscriptor!!.fileDescriptor
